        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link to="/#partners" className="text-gray-500 hover:text-blue-600">Partners</Link></li>
              <li><Link to="/#testimonials" className="text-gray-500 hover:text-blue-600">Testimonials</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><span className="text-gray-500">+234 810 000 0000</span></li>
            </ul>
          </div>
        </div>
