        ...
        <header className="bg-white/90 dark:bg-[#050505]/90 backdrop-blur-3xl sticky top-0 z-40 flex items-center justify-between px-8 lg:px-20 py-8 border-b border-gray-100 dark:border-white/5">
          ...
          <div className="flex items-center space-x-6 lg:space-x-10">
             ...
             <div className="relative group">
                <button 
                  className="w-16 h-16 rounded-[1.5rem] bg-gray-100 dark:bg-white/5 border-4 border-white dark:border-[#050505] shadow-2xl overflow-hidden flex items-center justify-center text-blue-600 font-black text-xl hover:scale-110 transition-all hover:bg-blue-600 hover:text-white"
                >
                   {user?.username?.charAt(0).toUpperCase() || 'U'}
                </button>
                
                {/* Profile Dropdown */}
                <div className="absolute right-0 mt-6 w-80 bg-white dark:bg-[#0f172a] rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-white/5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-500 z-50 p-8">
