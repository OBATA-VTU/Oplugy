    ...
    <div className="min-h-screen flex bg-white overflow-hidden">
      ...
      >
        ...
        <div className="max-w-md w-full mx-auto lg:mx-0">
          <div className="space-y-4 mb-12">
            <h2 className="text-[11px] font-black text-emerald-600 uppercase tracking-[0.5em]">Authentication</h2>
          ...
          <div className="mt-12 pt-8 border-t border-gray-50">
            <p className="text-center lg:text-left text-sm text-gray-500 font-medium">
              New to the platform?{' '}
              <Link to="/signup" className="font-black text-emerald-600 hover:text-gray-900 transition-all underline underline-offset-4">
                Create Account
              </Link>
            </p>
          </div>
      ...
      <div className="hidden lg:block lg:w-[55%] bg-gray-950 relative overflow-hidden">
          ...
          <div className="max-w-2xl space-y-16 relative z-10">
            <div className="space-y-6">
              <motion.div 
                ...
                className="inline-flex items-center space-x-3 px-4 py-2 bg-emerald-600/10 border border-emerald-500/20 rounded-full text-emerald-400"
              >
              ...
              >
                The Future of <br /><span className="text-emerald-600">VTU is Here.</span>
              </motion.h2>
              <motion.p 
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
        ...
        <div className="absolute top-0 right-0 w-full h-full pointer-events-none">
           <div className="absolute top-1/4 -right-20 w-96 h-96 bg-emerald-600/20 rounded-full blur-[120px] animate-pulse"></div>
           <div className="absolute bottom-1/4 -left-20 w-96 h-96 bg-teal-600/10 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '1s' }}></div>
        </div>
      </div>
    </div>
  );
...
const FeatureCard = ({ icon, title, desc }: { icon: React.ReactNode, title: string, desc: string }) => (
  ...
  >
    <div className="w-12 h-12 bg-emerald-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all shadow-lg shadow-emerald-600/20">
      {icon}
    </div>
