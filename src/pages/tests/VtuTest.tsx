              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-in fade-in">
                 <div className="space-y-6">
                    <div>
                       ...
                       <select value={network} onChange={(e) => { setNetwork(e.target.value); setDataType(''); setPlans([]); }} className="w-full bg-black border border-zinc-800 p-4 rounded-xl text-green-500 font-mono outline-none focus:border-green-500">
                    ...
                    <div>
                       ...
                       <select value={dataType} onChange={(e) => { setDataType(e.target.value); fetchPlans(e.target.value); }} className="w-full bg-black border border-zinc-800 p-4 rounded-xl text-green-500 font-mono outline-none focus:border-green-500">
                 ...
                 <div className="space-y-6">
                    <div>
                       ...
                       <select value={selectedPlanId} onChange={(e) => setSelectedPlanId(e.target.value)} className="w-full bg-black border border-zinc-800 p-4 rounded-xl text-green-500 font-mono outline-none focus:border-green-500">
                    ...
                    <div>
                       ...
                       <input type="text" value={phone} onChange={(e) => setPhone(e.target.value)} className="w-full bg-black border border-zinc-800 p-4 rounded-xl text-green-500 font-mono outline-none focus:border-green-500" />
                    </div>
                 </div>
              </div>
            )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-in fade-in">
                 <div className="space-y-6">
                    <div>
                       ...
                       <select value={cableBiller} onChange={(e) => { setCableBiller(e.target.value); setCustomerName(null); setCablePlans([]); }} className="w-full bg-black border border-zinc-800 p-4 rounded-xl text-green-500 font-mono outline-none focus:border-green-500">
                    ...
                    <div>
                       ...
                       <div className="flex gap-2">
                          <input type="text" value={iuc} onChange={(e) => setIuc(e.target.value)} className="flex-1 bg-black border border-zinc-800 p-4 rounded-xl text-green-500 font-mono outline-none focus:border-green-500" />
                 ...
                 <div className="space-y-6">
                    ...
                    <div>
                       ...
                       <select value={selectedCablePlan} onChange={(e) => setSelectedCablePlan(e.target.value)} className="w-full bg-black border border-zinc-800 p-4 rounded-xl text-green-500 font-mono outline-none focus:border-green-500 disabled:opacity-30" disabled={!customerName}>
                          <option value="">Select Plan</option>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-in fade-in">
                 <div className="space-y-6">
                    <div>
                       ...
                       <select value={disco} onChange={(e) => { setDisco(e.target.value); setCustomerName(null); }} className="w-full bg-black border border-zinc-800 p-4 rounded-xl text-green-500 font-mono outline-none focus:border-green-500">
                    ...
                    <div>
                       ...
                       <div className="flex gap-2">
                          <input type="text" value={meterNo} onChange={(e) => setMeterNo(e.target.value)} className="flex-1 bg-black border border-zinc-800 p-4 rounded-xl text-green-500 font-mono outline-none focus:border-green-500" />
