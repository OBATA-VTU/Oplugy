...
const FAQPage: React.FC = () => {
  ...
  const faqs = [
    { q: "What is OBATA v2?", a: "OBATA v2 is an independent high-velocity digital utility gateway for instant data, airtime, and bill payments." },
    { q: "How long does delivery take?", a: "Our average delivery time is 2 seconds. All transactions are automated and processed instantly via our independent nodes." },
    { q: "Is my money safe in the wallet?", a: "Yes. OBATA utilizes bank-grade encryption and ISO security standards to protect your liquidity and transaction data." },
    { q: "Can I use OBATA for business?", a: "Absolutely. Our Reseller and API tiers are designed specifically for high-volume users and independent merchants." },
    { q: "What if my transaction fails?", a: "In the rare event of a node failure, our system automatically triggers an instant refund to your wallet." }
  ];
    ...
    <div className="bg-white min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-6 py-24">
        <div className="text-center mb-20">
          <h2 className="text-blue-600 text-[10px] font-black uppercase tracking-[0.4em] mb-4">Knowledge Base</h2>
          <h1 className="text-5xl lg:text-7xl font-black text-gray-900 tracking-tighter leading-none">Intelligence Hub</h1>
        </div>
        ...
        <div className="bg-gray-900 rounded-[3rem] p-12 lg:p-20 text-white relative overflow-hidden text-center shadow-2xl">
           <div className="relative z-10">
              <h3 className="text-3xl lg:text-5xl font-black mb-6 tracking-tighter">Need Master Level Support?</h3>
              <p className="text-white/40 text-lg lg:text-xl font-medium mb-12 max-w-xl mx-auto">Link up with the OBATA PRO for administrative inquiries or technical clearance.</p>
              <a 
                href={whatsappUrl} 
                target="_blank" 
